...
#include <XFSCDM.H>
#include <common.h>
 #include "cdm/at_o2xfs_xfs_v3_20_cdm_Status320IT.h"
...
JNIEXPORT jbyteArray JNICALL Java_at_o2xfs_xfs_v3_120_cdm_Status320IT_createDefault(JNIEnv *env, jobject obj) {
