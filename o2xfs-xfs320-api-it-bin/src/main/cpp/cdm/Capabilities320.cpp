...
#include <XFSCDM.H>
#include <common.h>
#include "cdm/at_o2xfs_xfs_v3_20_cdm_Capabilities320IT.h"

static WFSCDMCAPS caps;
static LPSTR lpszExtra = "Key1=Value1\0Key2=Value2\0";

JNIEXPORT jbyteArray JNICALL Java_at_o2xfs_xfs_v3_120_cdm_Capabilities320IT_createDefault(JNIEnv *env, jobject obj) {
